...
public class VerVentasPendientes extends javax.swing.JPanel {
    ...
    String[] cabecera = {"CONSULTA", "EMPLEADO", "CLIENTE", "FECHA"};
    Object[][] data = {};
    ...
    public VerVentasPendientes(MenuPrincipal padre) {
        initComponents();
        lblMensaje.setText("");
    ...
    private void initComponents() {
        ...
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "VER VENTAS PENDIENTES"));
        ...
        jLabel1.setText("A continuación, se presentan todas las consultas que aun no han sido facturadas:");
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                .addGap(33, 33, 33)
                .addComponent(btnRealizarVenta, javax.swing.GroupLayout.PREFERRED_SIZE, 135, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(33, 33, 33)
    ...
    private void cargarTabla(){
        try{
            ...
            ArrayList<Consulta> listaConsultas = controlador.listarConsultas("factura pendiente", "");
    ...
    private void actualizarTabla(ArrayList<Consulta> listaConsultas){
        ...
        for(Consulta c: listaConsultas){
            ...
            fecha = c.getFecha();
            Object[] fila = {idConsulta, cliente, empleado, fecha};
    ...
    private void btnRealizarVentaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRealizarVentaActionPerformed
        int idConsulta;
        idConsulta = Integer.parseInt(JOptionPane.showInputDialog("Ingrese el ID de la consulta a facturar"));
        ConsultaControl controlador = new ConsultaControl();
        if(controlador.verificarConsultaConFacturaPendiente(idConsulta)){
            frmPadre.actualizarPanelContenido(new RegistrarVenta(frmPadre, idConsulta));
        }else{
            setMensaje("error", "El ID de la consulta proporcionada ya tiene factura, escoja uno de la tabla");
        }
