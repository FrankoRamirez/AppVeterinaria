...
public class VerClientes extends javax.swing.JPanel {
    ...
    String[] cabecera = {"ID", "Nombres", "DNI", "Sexo", "Correo", "Telefono", "Direccion"};
    String[][] data = {};
    ...
    private void initComponents() {
        ...
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "VER CLIENTES"));
        ...
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                .addContainerGap()
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(cbxFiltro, javax.swing.GroupLayout.DEFAULT_SIZE, 31, Short.MAX_VALUE)
    ...
    private void cargarTabla(){
        try{
            ...
            ArrayList<Cliente> listaClientes = controlador.listarClientes("todos","");
            actualizarTabla(listaClientes);
            
        }catch (Exception ex){
            setMensaje("error", "Hubo un problema al obtener los clientes de la base de datos: "+ex.getMessage());
        }
    }
    ...
    private void interaccionComboBox(){
        cbxFiltro.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (opcion.equals("DNI") || opcion.equals("Nombre")) {
    ...
    private void actualizarTabla(ArrayList<Cliente> listaClientes){
        ...
        for(Cliente c: listaClientes){
            ...
            Object[] fila = {idCliente, nombres, dni, sexo, correo, telefono, direccion};
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        try{
            ...
            switch(tipo){
                case "Mostrar todos" -> {
                    listaClientes = controlador.listarClientes("todos", "");
                }
                case "Nombre" -> {
                    if(txtClave.getText().equals("")){
                        throw new Exception ("Debe ingresar la palabra clave para buscar");
                    }else{
                        listaClientes = controlador.listarClientes("nombres",txtClave.getText());
                    }
                }
                case "DNI" -> {
                    if(txtClave.getText().equals("")){
                        ...
                        listaClientes = controlador.listarClientes("dni",txtClave.getText());
                    }
                }
                case "Ultimos agregados" -> {
                    listaClientes = controlador.listarClientes("recien agregado", "");
                }
                default -> {
                    listaClientes = controlador.listarClientes("todos", "");
                }
