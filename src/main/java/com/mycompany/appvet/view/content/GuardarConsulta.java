...
public class GuardarConsulta extends javax.swing.JPanel {
    ...
    public GuardarConsulta(MenuPrincipal padre) {
        initComponents();
        lblMensaje.setText("");
        frmPadre = padre;
    }
    ...
    private void initComponents() {
        ...
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "CREAR CONSULTA"));
        jPanel5.setPreferredSize(new java.awt.Dimension(760, 420));

        jLabel20.setText("Ingrese ID del cliente:");
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        if(verificacion()){
            ...
            try{
                ...
                c.setId_empleado(frmPadre.obtenerUsuario().getId_empleado());
                controlador.agregarConsulta(c);
                c = controlador.obtenerUltimaConsulta(idCliente);
                frmPadre.actualizarPanelContenido(new GuardarDetalleConsulta(frmPadre, c));
                setMensaje("info", "Se agrego la consulta exitosamente");
                limpiarEntradas();
