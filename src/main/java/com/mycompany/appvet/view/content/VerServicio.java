...
public class VerServicio extends javax.swing.JPanel {
    ...
    String[] cabecera = {"ID", "Descripcion", "Costo"};
    String[][] data = {};
    ...
    private void initComponents() {
        ...
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "VER SERVICIOS"));
        ...
        jLabel1.setText("Filtrar servicio por:");
    ...
    private void cargarTabla(){
        try{
            ...
            ArrayList<Servicio> listaServicios = controlador.listarServicios("todos","");
            actualizarTabla(listaServicios);
            
        }catch (Exception ex){
            setMensaje("error", "Hubo un problema al obtener los servicios de la base de datos: "+ex.getMessage());
        }
    }
    ...
    private void actualizarTabla(ArrayList<Servicio> listaServicios){
        limpiarTabla();
        for(Servicio s: listaServicios){
            idServicio = s.getId_servicio();
            descripcion = s.getDescripcion();
            costo = s.getCosto();
            Object[] fila = {idServicio, descripcion, costo};
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        try{
            ...
            switch(tipo){
                case "Mostrar todos" -> {
                    listaServicios = controlador.listarServicios("todos", "");
                }
                case "Nombre" -> {
                    if(txtClave.getText().equals("")){
                        throw new Exception ("Debe ingresar la palabra clave para buscar");
                    }else{
                        listaServicios = controlador.listarServicios("nombres",txtClave.getText());
                    }
                }
                case "Ultimos agregados" -> {
                    listaServicios = controlador.listarServicios("recien agregado", "");
                }
                default -> {
                    listaServicios = controlador.listarServicios("todos", "");
                }
