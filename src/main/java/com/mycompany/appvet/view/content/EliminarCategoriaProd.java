...
public class EliminarCategoriaProd extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "ELIMINAR CATEGORIA PRODUCTO"));
        ...
        jLabel1.setText("Ingrese el ID de la categoria a eliminar:");
    ...
    private boolean verificacion(){
        if(txtID.getText().equals("")){
            setMensaje("error","Debe ingresar el ID de la categoria a eliminar");
            return false;
        }
        return true;
    }
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        if(verificacion()){
            ...
            try{
                ...
                controlador.eliminarCategoriaProducto(idCat);
                setMensaje("info", "Se elimino la categoria exitosamente");
                limpiarEntradas();
