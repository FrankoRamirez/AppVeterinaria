...
public class ActualizarProducto extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "ACTUALIZAR PRODUCTO"));
                            ...
                            .addGroup(jPanel5Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                        ...
                                        .addComponent(txtCostoUnitario, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 136, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        if(verificacion()){
            ...
            try{
                ...
                setMensaje("info", "Se actualizo el producto exitosamente");
                limpiarEntradas();
                btnAceptar.setEnabled(false);
            
            }catch(Exception ex){
                setMensaje("error", "Error al actualizar el producto: "+ex.getMessage());
            }
        }
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        if(txtID.getText().equals("")){
            setMensaje("error", "Debe ingresar un producto a buscar");
        }else{
            idProducto = txtID.getText();
            try{
                ProductoControl controlador = new ProductoControl();
                Producto p = controlador.buscarProducto(idProducto);
                if(p.getId_producto().equals("-1")){
                    throw new Exception("Producto no encontrado");
                }else{
                    txtDescripcion.setText(p.getDescripcion());
                    txtUnidad.setText(p.getUnidad());
                    txtStock.setText(p.getStock()+"");
                    txtCostoUnitario.setText(p.getCostoUnitario()+"");
                    txtPrecioVenta.setText(p.getPrecioVenta()+"");
                    cargarCbx();
                    cbxCategoria.setSelectedItem(p.getCategoria());
                    
                    setMensaje("info","Ya puede actualizar la información de este producto");
                    btnAceptar.setEnabled(true);
                }
            }catch(Exception ex){
                setMensaje("error", "Error al buscar el producto: "+ex.getMessage());
            }
        }
