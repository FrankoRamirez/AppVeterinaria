...
public class ActualizarEmpleado extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "ACTUALIZAR EMPLEADO"));
                        ...
                        .addGroup(jPanel5Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    ...
                                    .addComponent(cbxSexo, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGroup(jPanel5Layout.createSequentialGroup()
                                    .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                        .addComponent(txtTelefono, javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(txtCorreo, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 181, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGap(74, 74, 74)
                                    .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(jPanel5Layout.createSequentialGroup()
                                            .addGap(90, 90, 90)
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        if(verificacion()){
            ...
            try{
                ...
                setMensaje("info", "Se actualizo el empleado exitosamente");
                limpiarEntradas();
                btnAceptar.setEnabled(false);
            
            }catch(Exception ex){
                setMensaje("error", "Error al actualizar el empleado: "+ex.getMessage());
            }
        }
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        if(txtID.getText().equals("")){
            setMensaje("error", "Debe ingresar un empleado a buscar");
        }else{
            idEmpleado = txtID.getText();
            try{
                EmpleadoControl controlador = new EmpleadoControl();
                Empleado e = controlador.buscarEmpleado(idEmpleado);
                if(e.getId_empleado().equals("-1")){
                    ...
                    if(e.getTipo().equals("Veterinario"))
                        cbxTipo.setSelectedIndex(1);
                    if(e.getTipo().equals("Cajero"))
                        cbxTipo.setSelectedIndex(2);
                    if(e.getTipo().equals("Administrador"))
                        cbxTipo.setSelectedIndex(3);
                    txtUser.setText(e.getUsuario());
                    txtPass.setText(e.getContrasenia());
                    setMensaje("info","Ya puede actualizar la información de este empleado");
                    btnAceptar.setEnabled(true);
                }
            }catch(Exception ex){
                setMensaje("error", "Error al buscar el empleado: "+ex.getMessage());
            }
        }
